...
const CasesSection: React.FC = () => {
  ...
  const tabsData = [
    ...
    {
      id: 2,
      title: 'Монтаж навесов и зимних садов',
        cases: [
          {
          id: 2,
          image: 'images/CasesImage.jpg',
          altText: 'Строители в желтых жилетах на участке',
          title: 'Как за 3 месяца превратить хаотичные продажи в систему с высокой конверсией',
          description: 'В строительном бизнесе главное - системность. И не только в чертежах и сборке, но и в работе отдела продаж, который понимает что нужно каждому клиенту.',
          stats: [
            {
              id: 1,
              icon: 'images/Frame 553.svg',
    ...
    {
      id: 3,
      title: 'Салон аппаратного массажа',
        cases: [
          {
          id: 3,
          image: 'images/CasesImage.jpg',
